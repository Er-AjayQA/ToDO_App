      ...
      <header className="relative">
        ...
        <nav className="bg-white dark:bg-gray-900 sticky w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-1">
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse ">
              <button
                type="button"
                className="hidden md:block bg-purple-primary hover:bg-purple-hover text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center"
              >
                Register
              </button>
              <button
        ...
        {isMobileMenuOpen ? (
          <div
            ...
            }  md:flex md:w-auto md:order-1 border border-gray-100 bg-gray-50`}
          >
